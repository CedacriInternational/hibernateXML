...
<%    
    ...
    if (personajName != null && personajRace != null && personajWeapon != null &&
                    personajHealth != null && personajShield != null &&  personajDamage != null) 
    {
        try 
        {
            ...
            {          
                int rez = manager.addPersonaj(personajName, Integer.parseInt(personajRace), personajWeapon, 
                        Integer.parseInt(personajHealth), Integer.parseInt(personajDamage), Integer.parseInt(personajShield));
                if (rez > 0)
                {
                    color = "style='color:green'";
                    output = "New Personaj was created!";                                  
                }     
                else 
                {
                    color = "style='color:red'";
                    output = "New Personaj was not created!";
                }      
            }
        } catch (NumberFormatException e) {
                color = "style='color:red;'";
                output = "give me some numbers already!";
        }
    } 
